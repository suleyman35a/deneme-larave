         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>mail</strong>
                        <textarea class="form-control" style="form-control" name="mail" placeholder="Mail">{{ $advisor->mail }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>tel</strong>
                        <textarea class="form-control" style="form-control" name="tel" placeholder="Tel">{{ $advisor->tel }}</textarea>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <img src="/images/{{ $advisor->image }}" width="300px">
                </div>
            </div>
